...
//     As of KSP 2.3.x, its Gradle plugin version is no longer suffixed with
//     a matching Kotlin version (no more "kotlinVersion-kspVersion" format) -
//     confirmed via Maven Central, latest plain release is 2.3.11.
plugins {
